...
use Prooph\StandardProjections\Container\CategoryStreamProjectionFactory;
...
class CategoryStreamProjectionTest extends TestCase
{
    ...
    public function it_can_create_myql_projection(): void
    {
        ...
        $factory = new CategoryStreamProjectionFactory();
        $projection = $factory($container->reveal());

        $this->assertInstanceOf(CategoryStreamProjection::class, $projection);
    }
